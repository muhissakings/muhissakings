    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.course')),
            ],
        ),
        migrations.CreateModel(
            name='Department',
            fields=[
                ...
                ('faculty_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.faculty')),
            ],
        ),
        migrations.AddField(
            model_name='course',
